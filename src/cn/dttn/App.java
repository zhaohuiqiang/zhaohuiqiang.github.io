...
import cn.dttn.algorithm.DivideConquer;
import cn.dttn.algorithm.Search;
import cn.dttn.algorithm.Sort;
...
public class App {
    ...
    private static void maxProduct() {
        int result = DivideConquer.maxProduct(new int[]{2, 3, -2, 5, 4, -3, -2, 6, -8, 6, 23, 4, 17, -4});
    ...
    private static void find() {
        ...
        for (int a : arr)
            System.out.println(a + "元素的索引为：" + Search.sortedBS(arr, a));
    }
